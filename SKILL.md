---
name: xxd-panel-161
description: "Create Panel 161 raster artwork: Frame-breaking Painted Colour Field. Use when the user invokes xxd-panel-161 or requests this specific visual language."
---
...
Write final PNGs directly inside one fresh task directory under `~/Desktop/xxd/xxd-panel-161/` or the explicit output root. Use collision-safe filenames; do not create source, mode, or size subdirectories and do not generate an automatic contact sheet.
...
- `references/xxd-panel-161-prompt.zh-CN.md` and `.en.md` — delivery adapter notes
